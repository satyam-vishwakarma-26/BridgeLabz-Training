...
On the first day of training, the focus was on setting up version control tools and understanding the repository structure.

#### Activities Completed
- Installed and configured Git on the local system.
- Created and configured a GitHub repository.
- Learned and practiced essential Git commands such as:
  - `git init`
  - `git clone`
  - `git add`
  - `git commit`
...
🔗 **Code Reference:**  
👉 [Day 1 – Class and Object](https://github.com/satyam-vishwakarma-26/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/gcr-codebase/JavaOopsConcepts/src/com/classandobject)
...
- Solved scenario-based logical problems:
...
*🔗 Code link:*  
[Java Regex & JUnit Practice](https://github.com/satyam-vishwakarma-26/BridgeLabz-Training/tree/java-collection-practice/java-collections-practice/gcr-codebase/JavaCollectionFramework/src/com)
...
<h2 align="center">📅 Week 6: Java 8 & its Features</h2>

---
### 🗓 Day 1: Java Lambda Expressions & Method References  
*Date: 27 January 2026*
#### 🔹 Topics Covered  

*Lambda Expressions*
- Functional interfaces  
- Writing concise behavior-based logic  
- Using Predicate and Comparator  
...
#### 🔸 Lambda Expression Scenarios
1. Smart Home Lighting Automation  
2. Custom Product Sorting in E-Commerce  
3. Notification Filtering using Predicate  

#### 🔸 Method Reference Scenarios
4. Hospital Patient ID Printing  
5. Employee Name Uppercasing (`String::toUpperCase`)  
6. Invoice Object Creation (Constructor Reference)  

*🔗 Code link:*  
[Lambda Expressions & Method References](https://github.com/satyam-vishwakarma-26/BridgeLabz-Training/tree/java8-programmming-practice/java8-programmming-practice/gcr-codebase/Java8Features/src/com/lanbdaexpressions)

---

### 🗓 Day 2: Java Interfaces & Functional Interfaces  
...
*Marker Interfaces*
- Tagging classes for special behavior  
- Serialization, cloning, and security use cases  
...
#### 🔸 Functional Interfaces
4. Temperature Alert System (Predicate)  
5. String Length Checker (Function)  
6. Background Job Execution (Runnable)  
...
10. Payment Gateway Refund Feature  
11. Data Export (CSV, PDF, JSON)  
12. Smart Vehicle Dashboard Enhancements  
...
- **Observer Pattern**  
  ...
  - Automatic state change notification  
...
- Class diagrams for pattern representation  
- Association, inheritance, and dependency relationships  
- Visualizing responsibilities and interactions  

### 🔹 Why Use Design Patterns?  

- Reusable and proven solutions  
- Improves flexibility and maintainability  
- Encourages best design practices  
- Makes systems easier to extend and understand  

### ✅ Practice & Case Studies  

1. Smart University Library Management System  
2. Library Management System (LMS) using GoF Patterns  
...
### 🗓 Day 1 – SQL Practice
**Date:** 6 Fabruary 2026

#### 🔹 Topics Covered  
- CRUD operations  
- Transaction management  
- Data validation and searching  
- Record handling and business logic implementation  
...
#### 🔸 Exercise 2: Banking System with Transactions
...
*🔗 Code link:*  
[Console-Based Application Projects](https://github.com/satyam-vishwakarma-26/BridgeLabz-Training/tree/dbms-jdbc-practice/dbms-jdbc-practice/gcr-codebase/MySqlPractice/src/com/mysqlpracticeexercise)
